...
public class RequestBuilder {
	...
	public ComputationalClusterConfigDTO newClusterConfigUpdate(UserInfo userInfo, String exploratory,
		...
		clusterConfigDTO.setComputationalName(compRes.getComputationalName());
		clusterConfigDTO.setConfig(config);
		clusterConfigDTO.setExploratoryName(exploratory);
