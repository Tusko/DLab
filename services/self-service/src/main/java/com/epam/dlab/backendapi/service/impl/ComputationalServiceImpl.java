...
public class ComputationalServiceImpl implements ComputationalService {
	...
	public void updateSparkClusterConfig(UserInfo userInfo, String exploratoryName, String computationalName,
		...
		final UserComputationalResource compResource = exploratoryDAO
		...
		final ComputationalClusterConfigDTO clusterConfigDto = requestBuilder.newClusterConfigUpdate(userInfo, exploratoryName,
				compResource, config);
